...
export default function useSVGComponent(type, height, selected) {
  ...
  switch (type) {
    case "반팔티":
      image = (
        <TShirt height={height} fill={mainColor} style={{ color: subColor }} />
      );
      break;
    case "민소매":
    ...
    case "목도리":
      image = (
        <Muffler height={height} fill={mainColor} style={{ color: subColor }} />
      );
      break;
    case "모자":
      image = (
        <Hat height={height} fill={mainColor} style={{ color: subColor }} />
      );
      break;
    default:
      image = null;
